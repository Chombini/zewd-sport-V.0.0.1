...
function ProdactItem({product,id}) {
  return (
    <div key={id} className='flex flex-col p-3 gap-2 border border-gray-300 rounded-lg hover:scale-110 hover:shadow-md transition-all ease-in-out cursor-pointer'>
       ...
       <Dialog>
          <DialogTrigger asChild>
           <Button variant='outline' className="bg-primary text-white border-none">Add to Cart</Button>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
