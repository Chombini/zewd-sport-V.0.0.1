...
function ProdactDetail({product}) {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 p-4 text-black gap-0'>
        <div className='flex justify-center items-center'>
        <Image src={product.img} alt='prodact-img' className='rounded-lg object-left w-[220px] h-[260px] md:w-[250px] md:h-[310px]' width={300} height={300}/>
        </div>
          ...
          <div className=''>
           ...
           <div className='flex flex-col md:items-baseline gap-5 justify-center items-center md:justify-normal'>
            <div className='flex gap-3 items-center'>
                <div className='p-2 border border-gray-400 flex md:gap-9 gap-6 items-center px-5'>
